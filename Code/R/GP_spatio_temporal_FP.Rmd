...
```{r}
library(cmdstanr)
set_cmdstan_path('/Users/FRANCESP/Library/Mobile Documents/com~apple~CloudDocs/Documents/cmdstan')
...
```{r}
base_path = '/Users/FRANCESP/Library/Mobile Documents/com~apple~CloudDocs/Documents/Research/GP_food_insecurity/Food-insecurity-GP-forecasting/'
...
mod = cmdstan_model(stan_file,  include_paths = stan_path, compile=TRUE)
...
modpred = cmdstan_model(stan_file,  include_paths = stan_path, compile=TRUE)
#modpred$format(canonicalize = TRUE, overwrite_file = TRUE)
#modpred$compile()
```
...
pred$save_output_files(dir = paste0(base_path,"Output"), basename = NULL, timestamp = TRUE, random = TRUE)
